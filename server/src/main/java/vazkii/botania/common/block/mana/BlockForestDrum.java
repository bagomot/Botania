...
public class BlockForestDrum extends BlockMod implements IManaTrigger, ILexiconable
{
	...
	public BlockForestDrum()
	{
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(BotaniaStateProps.DRUM_VARIANT, DrumVariant.WILD));
	}
	...
	public IBlockState getStateFromMeta(int meta)
	{
		if (meta >= DrumVariant.values().length)
			meta = 0;
		return this.getDefaultState().withProperty(BotaniaStateProps.DRUM_VARIANT, DrumVariant.values()[meta]);
	}
