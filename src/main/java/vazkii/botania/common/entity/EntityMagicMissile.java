        ...
        if(target != null) {
            ...
            if(targetList.contains(target)) {
                ...
                if(thrower != null) {
                    ...
                    // TODO: Start bagomot's fix
                    if(player == null) {
                        target.attackEntityFrom(DamageSource.causeMobDamage(thrower), evil ? 12 : 7);
                    } else if(!EventUtils.cantAttack(player, target)){
                        target.attackEntityFrom(DamageSource.causePlayerDamage(player), evil ? 12 : 7);
                    }
                    // TODO: End fix
